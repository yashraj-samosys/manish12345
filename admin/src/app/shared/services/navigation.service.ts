...
export class NavigationService {
    ...
    async getnavbar() {
        ...
        return Navbar.filter((e) => { return newara.includes(e.id) });
    }
    // goto sidebar-large.component
    ...
    defaultMenu: IMenuItem[] = [
        ...
        },
        {
            ...
            icon: 'i-Add-User',
            sub: [
                { icon: 'i-Business-Man', name: 'Partner Agent', state: '/users/list-default-agent', type: 'link' },
                { icon: 'i-Business-Man', name: 'Client Agent', state: '/users/list-client', type: 'link' },
                { icon: 'i-Business-Man', name: 'Public User', state: '/users/list-users', type: 'link' },
                // { icon: 'i-Business-Man', name: 'Partner Agent', state: '/users/list-partner', type: 'link' },
            ]
        },
        {
            name: 'FSA',
    ...
    defaultAgent: IMenuItem[] = [
        ...
        },
        {
            ...
            type: 'link',
            icon: 'i-Bar-Chart',
            state: '/users/list-partner'
        }
    ];

    subAgent: IMenuItem[] = [
        {
            name: 'Dashboard (Sub Agent)',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
            type: 'link',
            icon: 'i-Bar-Chart',
            state: './dashboard/v1'
    ...
    menuItems = new BehaviorSubject<any>(Navbar);
    // menuItems = new BehaviorSubject<IMenuItem[]>(this.user_type == '1' ? this.defaultMenu : this.user_type == '2' ? this.defaultAgent : null);
